		...
		<div className='flex bg-[#F4F4F5] min-h-screen'>
			<div className='flex flex-col flex-1 overflow-hidden ml-[60px]'>
				...
				<main className='flex-1 p-4 overflow-auto'>
					<div className='grid grid-cols-[2fr_3fr] gap-2 h-full'>
						<section className='bg-white rounded-[15px] p-[10px] flex flex-col'>
							<h2 className='dashboard-section-font mb-2'>Карта склада</h2>
