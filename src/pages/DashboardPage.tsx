...
import { ForecastAI } from "@/components/ui/ForecastAI";
                ...
                <header className="bg-white h-[60px] flex items-center px-[14px] z-10">
                    ...
                    <div className="ml-auto flex items-center gap-4">
                        ...
                        >
                            ...
                            <ChevronDown
                            fill="#7700FF"
                            className={`w-[20px] h-[20px] transition-transform duration-200 ${isDropdownOpen ? "rotate-180" : ""}`}
                            />
                        </Button>
                                ...
                                <div className="flex flex-col gap-4">
                                    <div className="bg-white rounded-[10px] h-[95px] flex flex-col p-[6px] pl-[12px]">
                                        ...
                                        <div className="flex flex-col items-center justify-center">
                                            ...
                                            <p className="text-[10px] text-[#CCCCCC] font-[400]">активных/всего</p>
                                        </div>
                                    </div>
                                    <div className="bg-white rounded-[10px] h-[95px] flex flex-col p-[6px] pl-[12px]">
                                        <h3 className="font-medium text-[18px]">Проверено за 24 ч</h3>
                                        <div className="flex flex-col items-center justify-center">
                                            <span className="text-[30px] font-bold">1430</span>
                                            <p className="text-[10px] text-[#CCCCCC] font-[400]">позиций</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="bg-white rounded-[15px] pl-[10px] pt-[6px] pr-[10px] pb-[10px] col-span-2 h-[334px]">
                                <h3 className="font-medium text-[18px]">Последние сканирования</h3>
